...
<body>
    <main class="table" id="customers_table">
        <section class="table__header">
            <h1>Inventario de Donaciones</h1>
    ...
    <form class="form" action="agregardona.php" name="ejemplo" method="post">
...
$sql = "SELECT lote, medicamento, ml_mg, vencimiento, cantidad FROM donaciones";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td><a href='eliminardona.php?lote=" . urlencode($row["lote"]) . "' onclick='return confirm(\"¿Estás seguro de eliminar este registro?\")'>Eliminar</a></td>";
        echo "</tr>";
    }
} else {
