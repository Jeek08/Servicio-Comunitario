...
<body>
    ...
    <form class="form" action="agregarotros.php" name="ejemplo" method="post">
...
$sql = "SELECT lote, medicamento, ml_mg, vencimiento, cantidad FROM otros";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td><a href='eliminarotros.php?lote=" . urlencode($row["lote"]) . "' onclick='return confirm(\"¿Estás seguro de eliminar este registro?\")'>Eliminar</a></td>";
        echo "</tr>";
    }
} else {
